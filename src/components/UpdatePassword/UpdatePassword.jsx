...
export default function UpdatePassword() {
  ...
  let validateSchema = Yup.object({
    ...
    newPassword:Yup.string().matches(/^[A-z][a-z0-9]{5,10}$/, 'password is invalid start with upper case and min is 5 char').required('password is required'),
  })


  async function updatePassSubmet(values){
    setisLoading(true)
 ...
 return <>
  ...
  <div className='w-75 mx-auto py-5'>
      ...
      <input onBlur={formik.handleBlur} onChange={formik.handleChange} value={formik.values.newPassword} className='form-control mb-2' type="password"  name='newPassword' id='newPassword'/>
